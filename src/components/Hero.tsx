    ...
    <section className="relative w-full h-[600px] flex overflow-hidden">
      ...
      <div className="absolute inset-0 z-30 flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
          ...
          <button className="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white border border-white/30 px-8 py-4 rounded font-semibold text-sm transition-colors">
            {t('contact_btn')}
          </button>
        </div>
      </div>
