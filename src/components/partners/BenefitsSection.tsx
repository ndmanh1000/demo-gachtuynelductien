...
export default function BenefitsSection({ benefits, subtitle, title, description }: BenefitsSectionProps) {
  return (
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <div className="relative">
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${benefit.color} rounded-2xl mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg`}
                >
              ...
              <div
                className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${benefit.color} opacity-0 group-hover:opacity-10 rounded-bl-full transition-opacity duration-500`}
              ></div>
            </div>
          ))}
        </div>
